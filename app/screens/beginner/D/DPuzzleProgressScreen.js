...
export default function DPuzzleProgressScreen({ navigation }) {
  ...
  // D letter puzzles data
  const puzzles = [
    { id: 1, name: 'DOG', image: require('../../../../assets/items/dog.png') },
    { id: 2, name: 'DUCK', image: require('../../../../assets/items/duck.png') },
    { id: 3, name: 'DOOR', image: require('../../../../assets/items/door.png') },
    { id: 4, name: 'DESK', image: require('../../../../assets/items/desk.png') },
    { id: 5, name: 'DOLL', image: require('../../../../assets/items/doll.png') },
  ];
  ...
  useEffect(() => {
    const loadPuzzleStatus = async () => {
      try {
        const storedStatus = await AsyncStorage.getItem('dPuzzleStatus');
        if (storedStatus) {
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>D Words Progress</Text>
          ...
          <View style={styles.puzzlesGrid}>
            {puzzles.map((puzzle) => (
              <TouchableOpacity 
                ...
                onPress={() => navigation.navigate(`WordPuzzleScreenD${puzzle.id}`, {
                  word: puzzle.name,
                  image: puzzle.image
                })}
              >
